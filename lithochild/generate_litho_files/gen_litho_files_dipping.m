...
depths=(kd-7000)+800.*(1-yi./max(max(yi)));
depths2=(kd-1000)+800.*(1-yi./max(max(yi)));
depths3=(kd-30000)+800.*(1-yi./max(max(yi)));
...
dpdd3_2=gg(:,10);
  ...
  units=[0 1 2];
  kdvals=[0.0000001 0.00000001 0.00000001];
  kbvals=[0.000005 0.00001 0.000005];
  sedrockflag=[1 1 1];
  Dgrade=[1 1 1];
  ...
  surface(xi,yi,depths2+depths)
hold on
surface(xi,yi,depths)