...
CHARACTER(40) :: filenodes,filetri,filez,filetau, fileq, fileslp,filearea, filekb, fileup
REAL,dimension(:,:), ALLOCATABLE  :: TABNODES, TABZ, TABTAU, TABQ, TABSLP,TABAREA, TABKB, TABUP
...
! opening file .kb
filekb=TRIM(TRIM(pref) // '.kb')
write(*,*) 'Opening ', filekb
OPEN(100,FILE=filekb,STATUS='OLD')

! opening file .up
fileup=TRIM(TRIM(pref) // '.up')
write(*,*) 'Opening ', fileup
OPEN(110,FILE=fileup,STATUS='OLD')
...
write(20,'(a11,i10)')'POINT_DATA ',NN
      ...
      write(20,'(a)')'SCALARS KB float 1'
      write(20,'(a)')'LOOKUP_TABLE default'
      DO I=1,NN
      write(20,*)TABKB(I,1)
      ENDDO
       write(20,'(a)')'SCALARS Uplift float 1'
      write(20,'(a)')'LOOKUP_TABLE default'
      DO I=1,NN
      write(20,*)TABUP(I,1)
      ENDDO
