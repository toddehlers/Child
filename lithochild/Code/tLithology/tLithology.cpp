...
//	      std::cout << "erody" << erody[i] << "\n";
	     ...
	     // update all the rest of the lower units
          ...
          //debug 05 2014 BJY commented to test
...
//		}
	    ...
	    nextdepth = cn->getLithoContactDepths(locindex);
            nextdepth= locnextdepth + nextdepth;
	    ...
	    lockd = KDLookupTable[newunit];
           ...
           {
               lockd=0.00001;
               std::cout << "HARDWIRED HILLSLOEP DIFFUSIVITY ON BOUNDARY? " << i << "\n";
           }
	    cn->setKD(lockd);
//	       	  	    std::cout << lockd << " newunit " << newunit << "\n";
//            std::cout << locnextdepth << " locnextdepth locindex" << locindex << "\n";
...
//            std::cout << nextdepth << " new depth" << "\n";
//            std::cout << locz << " surface elevation" << "\n";
            
//            std::cout << locuplift << " loc uplift   delt " << delt << "\n";
