...
OBJECTS = \
 ...
 TipperTriangulatorError.$(OBJEXT) tLithology.$(OBJEXT)
...
tLithology.$(OBJEXT): $(PT)/tLithology/tLithology.cpp
	$(CXX) $(CFLAGS) $(PT)/tLithology/tLithology.cpp
